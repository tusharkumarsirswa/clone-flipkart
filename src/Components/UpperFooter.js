...
function UpperFooter() {
  return (
    <>
    <div>
      <p className='minipara '>Top Stories:<strong>Brand Directory</strong></p>

      <p className='minipara mx-5'><strong>MOST SEARCHED FOR ON FLIPKART:</strong>Bounce Infinity | E1iPhone 14 | Coversvivo | T1XOPPO Reno8 | 5GOPPO | Reno8 Pro | 5GNothing Phone | 1Sell Old Mobile | PhonesASUS | TUF Gaming | F15 Core i5 10th | GenElectronics StoreOPPO | A16KVivo | Y33TOPPO | Reno7 5GBathroom | Exhaust | FanSamsung | Window | ACOPPO Reno7 Pro | 5GiPhone | 13iPhone | 13 ProiPhone | 13 Pro MaxiPhone | 13 MiniGoogle | Pixel 6a coversFlipkart | QuickBooksFlipkart | Help CentreOnline | Boat StoreCovers | from Rs 99Flipkart | Track OrdersFlipkart | Manage OrdersFlipkart | Return OrdersFlipkart | Gift Cards | StoreFlipkart | Axis Bank Credit | CardFlipkart | Pay Later |</p>


      <p className='minipara '> <strong>MOBILES:</strong>iPhone 12 | 64GBiPhone 12 Pro | 512GBiPhone | 12 |128GBVivo | Y91iVivo | Y11Vivo | Y15Vivo | Y50Vivo | Y12Reno2 | FOppo | A12Oppo | F15Oppo | A31Samsung | A71Samsung | A51Samsung | A31Realme | X2iPhone | 11iPhone | 11 ProiPhone | 11 Pro | MaxMobile | Offersiphone | x4G MobileNokia | MobileSamsung | MobileiphoneOppo | MobileVivo | Mobile</p>

      <p className="minipara "><strong>CAMERA:</strong>GoPro Action | CameraNikon | CameraCanon | CameraSony | CameraCanon | DSLRNikon | DSLR</p>

      <p className="minipara "><strong>LAPTOPS:</strong>MacBook Pro | M2acer | Ryzen 3 | Dual Core 3250U - (8 GB/256 GB SSD/Windows 11 Home) | Z2-493 Thin and Light LaptopASUS | Vivobook S14 OLED (2022) |ASUS Zenbook 14 OLED (2022) |Realme Book Prime Core i5 11th | GenMicrosoft | Surface Go Pentium 128GBBranded | LaptopsApple | LaptopsAcer | LaptopsLenovo | LaptopsDell | LaptopsAsus | LaptopsHP | LaptopsGaming | Laptops2 | in 1 LaptopsLaptopsDell | latest laptops 2022HP | latest laptops | 2022Infinix | INBook X1 Neo Series | Celeron Quad Core - (8 GB/256 GB SSD/Windows 11 Home) | XL22 Thin and Light | LaptopMicrosoft | Laptops12th Gen Intel Core Laptops |</p>

      <p className="minipara "><strong>TVS:</strong>Nokia | TVPanasonic | TVThomson | TVVu | TVRealme | TVMotorola | TVOnePlus | TVsLG | TVTVSony | TVSamsung | TVAndroid | TelevisionIffalcon | TvMi | TV</p>

      <p className="minipara "><strong>LARGE APPLIANCES:</strong>TV & Appliances End of Season SaleTelevisionWashing | MachinesRefrigeratorsAir ConditionersElectric | CookersElectric | Jug(Heater) / Travel KettlesInduction | CooktopsInverters / stabilizerIrons / Iron BoxMixer Grinder JuicerWet | GrindersChimneysMicrowave | OvensVacuum | CleanersWater | PurifierFanMarQ | Customer Care|</p>

      <p className="minipara "><strong>CLOTHING:</strong>Men ShirtsKurta | PajamaKurtasMen | T-ShirtsJeansSareeDressesKids | DressesDesigner | Salwar SuitsBraDesigner | KurtisTrack | PantMen KurtasGym | WearParty | DressesPalazzo | SuitsBoys | ClothingGlovesNightyMaxi | DressesAnarkaliGownsCulottesSalwar | SuitsKurtisDesigner | SareesLeggingsShortsGeorgette | SareesEthnic WearBriefs & TrunksNike | WatchesAscot TieCorset Tops | TunicsLeather PU SkirtsCorset tops | camisolesWomen magenta | earringsNo collar | jacketsGreen | dress materialBlack | patiala kurta setMen | camel shoes | casualBlack | pathaniWallets | slingKhaki dressesKids | formal dressesMauve | shirtsWomen | henleyIndigo | trousersLeopard | dressesSleeveless shrugs |</p>
      
      <p className="minipara "><strong>FOOTWEAR:</strong>ShoesAdidas | ShoesReebok ShoesNike | ShoesPuma | ShoesBootsBata | ShoesWoodland | ShoesSkechers ShoesSneakersWomens | BootsSports | ShoesLoafersSandalsLotto | Sports ShoesCasual | ShoesWomens | Skechers | ShoesAsics Sports | ShoesFormal ShoesSchool | Shoes |</p>

      <p className="minipara "><strong>GROCERIES:</strong>PhonePe | Grocery | VoucherHand | WashSoapCashew | NutsSunflower | OilEggsToilet | CleanerHarpic Toilet | CleanerDettol | SoapMustard | OilBiscuitsCheesePatanjali | AttaFortune | OilAashirvaad | AttaTea</p>
      
      <p className="minipara "><strong>BEST SELLING ON FLIPKART:</strong>Fire-Boltt | Ninja Calling Pro | Bluetooth Calling Smartwatch 1.69 inch HD Display | SmartwatchBest | Gas GeyserKitchen | GeyserNutri | BlendersPortable Air CoolerBest | Air CoolerBagsHitachi | Refrigerator 3  |DoorBooksToysCandlesHelmetsWall | ClocksBaby | FoodChocolatesCyclesCalculatorsLipsticksMaskVertiv | UPSFastrack | WatchesWalletsEarringsGold | CoinsRealme | Pad MiniHandbagsconekt | SW2 SmartwatchMivi | DuoPods | a350Speaker | Cleaner</p>
      

      <p className="minipara "><strong>FURNITURE:</strong>FurnitureSofasBedsDining | setsWardrobesMattressesTV | UnitsTablesChairsShelvesBean | BagsOffice | ChairsComputer | TableOffice | TablesRed | SofaWakefit | BedsWhite | SofaWakefit | MattressGreen | SofaBlack | SofaBrown Sofa |</p>
      
      <p className="minipara "><strong>BGMH:</strong>Whey ProteinHomeopathyBounce | InfinityToysRusOnline | GuitarBooks | StoreMusical | Instrument | StoreEnergy | DrinksToysMilk | Drink | MixesRakhiIndian | FlagProtein | Supplements |</p>

    </div>
    <div className='my-5'>

          <p className='minipara'><strong>Flipkart: The One-stop Shopping Destination</strong>E-commerce is revolutionizing the way we all shop in India. Why do you want to hop from one store to another in search of the latest phone when you can find it on the Internet in a single click? Not only mobiles. Flipkart houses everything you can possibly imagine, from trending electronics like laptops, tablets, smartphones, and mobile accessories to in-vogue fashion staples like shoes, clothing and lifestyle accessories; from modern furniture like sofa sets, dining tables, and wardrobes to appliances that make your life easy like washing machines, TVs, ACs, mixer grinder juicers and other time-saving kitchen and small appliances; from home furnishings like cushion covers, mattresses and bedsheets to toys and musical instruments, we got them all covered. You name it, and you can stay assured about finding them all here. For those of you with erratic working hours, Flipkart is your best bet. Shop in your PJs, at night or in the wee hours of the morning. This e-commerce never shuts down.
...
Check out https://www.flipkart.com/plus/all-offers for the entire list. Terms and conditions apply.</p>
        ...
        <p className="minipara"><strong>EMI on Debit Cards</strong>Did you know debit card holders account for 79.38 crore in the country, while there are only 3.14 crore credit card holders? After enabling EMI on Credit Cards, in another attempt to make online shopping accessible to everyone, Flipkart introduces EMI on Debit Cards, empowering you to shop confidently with us without having to worry about pauses in monthly cash flow. At present, we have partnered with Axis Bank, HDFC Bank, State Bank of India and ICICI Bank for this facility. More power to all our shoppers! Terms and conditions apply.</p>

        <p className="minipara"><strong>Mobile Exchange Offers</strong>Get an instant discount on the phone that you have been eyeing on. Exchange your old mobile for a new one after the Flipkart experts calculate the value of your old phone, provided it is in a working condition without damage to the screen. If a phone is applicable for an exchange offer, you will see the 'Buy with Exchange' option on the product description of the phone. So, be smart, always opt for an exchange wherever possible. Terms and conditions apply.</p>

        <p className='mx-5 my-2'><strong>What Can You Buy From Flipkart? <br />
Mobile Phones</strong></p>
        ...
        <p className="minipara"><strong>Electronic Devices and Accessories</strong>When it comes to laptops, we are not far behind. Filter among dozens of super-fast operating systems, hard disk capacity, RAM, lifestyle, screen size and many other criterias for personalized results in a flash. All you students out there, confused about what laptop to get? Our Back To College Store segregates laptops purpose wise (gaming, browsing and research, project work, entertainment, design, multitasking) with recommendations from top brands and industry experts, facilitating a shopping experience that is quicker and simpler.
